...
import (
	...
	bigquery "github.com/adbc-drivers/bigquery/go"
...
var drv = bigquery.NewDriver(alloc)
...
func initLoggingFromEnv(db adbc.DatabaseLogging) {
	...
	case "tempfile":
		...
		f, err := os.CreateTemp("", "adbc-bigquery.*.log")
		if err == nil {
			sink = f
		} else {
			fmt.Fprintf(os.Stderr, "[bigquery] could not open temporary log file: %v", err)
		}
	}
