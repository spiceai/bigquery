...
// const char* BigQueryArrayStreamGetLastError(struct ArrowArrayStream*);
// void BigQueryArrayStreamRelease(struct ArrowArrayStream*);
//
// int BigQueryArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int BigQueryArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
import (
	...
	"github.com/adbc-drivers/bigquery/go"
...
var drv = bigquery.NewDriver(mallocator.NewMallocator())
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_BigQueryError, C.size_t(1))
	cErr := (*C.struct_BigQueryError)(cErrPtr)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("BigQuery does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "BigQuery: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
//export BigQueryArrayStreamGetLastError
func BigQueryArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
...
//export BigQueryArrayStreamGetNext
func BigQueryArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.BigQueryArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export BigQueryArrayStreamGetSchema
func BigQueryArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.BigQueryArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export BigQueryArrayStreamRelease
func BigQueryArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.BigQueryArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export BigQueryErrorFromArrayStream
func BigQueryErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.BigQueryArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.BigQueryArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.BigQueryArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.BigQueryArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.BigQueryArrayStreamRelease)
...
//export BigQueryDatabaseGetOption
func BigQueryDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryDatabaseGetOptionBytes
func BigQueryDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryDatabaseGetOptionDouble
func BigQueryDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryDatabaseGetOptionInt
func BigQueryDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryDatabaseInit
func BigQueryDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryDatabaseNew
func BigQueryDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryDatabaseRelease
func BigQueryDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export BigQueryDatabaseSetOption
func BigQueryDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryDatabaseSetOptionBytes
func BigQueryDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func BigQueryDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func BigQueryDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetOption
func BigQueryConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetOptionBytes
func BigQueryConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetOptionDouble
func BigQueryConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetOptionInt
func BigQueryConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionNew
func BigQueryConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionSetOption
func BigQueryConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionSetOptionBytes
func BigQueryConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionSetOptionDouble
func BigQueryConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionSetOptionInt
func BigQueryConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionInit
func BigQueryConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionRelease
func BigQueryConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionCancel
func BigQueryConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetInfo
func BigQueryConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetObjects
func BigQueryConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export BigQueryConnectionGetStatistics
func BigQueryConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetStatisticNames
func BigQueryConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export BigQueryConnectionGetTableSchema
func BigQueryConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionGetTableTypes
func BigQueryConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionReadPartition
func BigQueryConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryConnectionCommit
func BigQueryConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func BigQueryConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementGetOption
func BigQueryStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementGetOptionBytes
func BigQueryStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementGetOptionDouble
func BigQueryStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementGetOptionInt
func BigQueryStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementNew
func BigQueryStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementRelease
func BigQueryStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func BigQueryStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
	...
	active := st.cancelExecutionContext()
	canceller, ok := st.stmt.(statementCanceller)
	if !ok {
		if active {
			return C.ADBC_STATUS_OK
		}
	...
	if e := canceller.Cancel(context.Background()); e != nil {
...
//export BigQueryStatementPrepare
func BigQueryStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func BigQueryStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
	...
	if out == nil {
		ctx := st.beginExecutionContext()
		defer st.finishExecutionContext(ctx)
...
//export BigQueryStatementExecuteSchema
func BigQueryStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export BigQueryStatementSetSqlQuery
func BigQueryStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementSetSubstraitPlan
func BigQueryStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementBind
func BigQueryStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementBindStream
func BigQueryStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementGetParameterSchema
func BigQueryStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementSetOption
func BigQueryStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementSetOptionBytes
func BigQueryStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementSetOptionDouble
func BigQueryStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementSetOptionInt
func BigQueryStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export BigQueryStatementExecutePartitions
func BigQueryStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func AdbcDriverBigqueryInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.BigQueryDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.BigQueryDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.BigQueryDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.BigQueryDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.BigQueryConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.BigQueryConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.BigQueryConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.BigQueryConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.BigQueryConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.BigQueryConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.BigQueryConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.BigQueryConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.BigQueryConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.BigQueryConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.BigQueryConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.BigQueryStatementNew)
	driver.StatementRelease = (*[0]byte)(C.BigQueryStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.BigQueryStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.BigQueryStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.BigQueryStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.BigQueryStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.BigQueryStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.BigQueryStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.BigQueryStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.BigQueryStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.BigQueryStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.BigQueryErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.BigQueryErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.BigQueryErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.BigQueryDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.BigQueryDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.BigQueryDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.BigQueryDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.BigQueryDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.BigQueryDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.BigQueryDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.BigQueryConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.BigQueryConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.BigQueryConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.BigQueryConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.BigQueryConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.BigQueryConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.BigQueryConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.BigQueryConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.BigQueryConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.BigQueryConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.BigQueryStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.BigQueryStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.BigQueryStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.BigQueryStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.BigQueryStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.BigQueryStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.BigQueryStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.BigQueryStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.BigQueryStatementSetOptionInt)
	}
